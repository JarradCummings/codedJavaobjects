...
//Import statement Decimal Format

import java.text.*;     

//The BankAccount and classes
...
public class AccountDriver
{
   public static void main(String[] args)
   {
      ...
      if (completed)
      {
            System.out.println ("After withdrawl of $" + money_out
                        + ", balance = $"+ money);
       }
       else
       {
        ...
        SavingsAccount yourAccount =
               new SavingsAccount ("William Shakespear", 400);
        System.out.println ("Account Number"
                     +yourAccount.getAccountNumber()+
                     " belongs to " + yourAccount.getOwner());
        ...
        if(completed)
        {
         ...
         else
         {
          ...
          money = myFormat.format(yourAccount.getBalance());
          System.out.println ("After montyly interest has been posted,"
                     + "balance = $" + money);
          System.out.println();
          
          //to test the copy constructor of the saving account class
          ...
          System.out.println ("Intial balance = $" + money);
